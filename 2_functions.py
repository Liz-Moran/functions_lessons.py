...
# Declare a Function: Create a function called welcome that takes a person's name as an parameter
# This function should print "Welcome {name}!" whenever it is called.
